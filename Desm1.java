...
public class Desm1 extends Configured implements Tool 
{	
	...
	try
	 {  
		...
		SecretKeySpec skeySpec = new SecretKeySpec(kb, "DES");
   ...
   public int run(String[] args) throws Exception 
        {
            ...
            Job job = new Job(conf, "DES example for hadoop 0.20.1");
            job.setJarByClass(Desm1.class);
	  ...
	  FileOutputFormat.setCompressOutput(job, true);
        ...
        {
                int res = ToolRunner.run(new Configuration(), new Desm1(), args);
		System.exit(res);
        }
}